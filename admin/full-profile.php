...
<?php
		 $ret= mysqli_query("SELECT * FROM registration where regno = ?");
...
<td class="comb-value1"><?php echo $row['dname'];?></td>
</tr>
...
<td class="comb-value1"><?php echo $row['email_id'];?></td>
</tr>
...
<tr>
<td width="12%" valign="top" class="heading">Zone: </td>
<td class="comb-value1"><?php echo $row['corresZone'];?></td>
</tr>
...
<tr>
<td width="12%" valign="top" class="heading">Zone: </td>
<td class="comb-value1"><?php echo $row['pmnatetZone'];?></td>
</tr>
...
<td class="comb-value1"><?php echo $row['pmntZone'];?></td>
</tr>
<?php } ?>
